...
class GetCartesianPathRequest(genpy.Message):
  _md5sum = "97b21c683d2b97f701099048039a05af"
...
Pose pose
"""
  __slots__ = ['header','start_state','group_name','link_name','waypoints','max_step','jump_threshold','prismatic_jump_threshold','revolute_jump_threshold','avoid_collisions','path_constraints','cartesian_speed_limited_link','max_cartesian_speed']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,start_state,group_name,link_name,waypoints,max_step,jump_threshold,prismatic_jump_threshold,revolute_jump_threshold,avoid_collisions,path_constraints,cartesian_speed_limited_link,max_cartesian_speed
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.cartesian_speed_limited_link = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.cartesian_speed_limited_link = str[start:end]
      start = end
      end += 8
...
class GetCartesianPathResponse(genpy.Message):
  _md5sum = "13da68a622269d4097c7ad732fb4a27f"
...
class GetCartesianPath(object):
  ...
  _md5sum = 'c54b9430d97ea6816e0f7c7ffd3779b8'
