...
class MotionSequenceItem(genpy.Message):
  _md5sum = "605a152161827d49a0abacf6c6544d1e"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.req.cartesian_speed_limited_link
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.req.cartesian_speed_limited_link = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.req.cartesian_speed_limited_link = str[start:end]
      _x = self
      start = end
      end += 16
