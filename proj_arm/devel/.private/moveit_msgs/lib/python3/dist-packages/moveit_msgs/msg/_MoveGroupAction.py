...
class MoveGroupAction(genpy.Message):
  _md5sum = "33225407c32b189345eec6893a5a0da3"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.action_goal.goal.request.cartesian_speed_limited_link
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.request.cartesian_speed_limited_link = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.request.cartesian_speed_limited_link = str[start:end]
      start = end
      end += 8
