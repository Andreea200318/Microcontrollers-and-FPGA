...
class MoveGroupActionGoal(genpy.Message):
  _md5sum = "b7138704cefd43a8dd9758d697350b85"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.goal.request.cartesian_speed_limited_link
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.request.cartesian_speed_limited_link = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.request.cartesian_speed_limited_link = str[start:end]
      start = end
      end += 8
