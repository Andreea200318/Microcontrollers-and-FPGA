...
(cl:defclass <MotionPlanRequest> (roslisp-msg-protocol:ros-message)
  ((workspace_parameters
   ...
   (cartesian_speed_limited_link
    :reader cartesian_speed_limited_link
    :initarg :cartesian_speed_limited_link
    :type cl:string
    :initform "")
   (max_cartesian_speed
...
(cl:ensure-generic-function 'cartesian_speed_limited_link-val :lambda-list '(m))
(cl:defmethod cartesian_speed_limited_link-val ((m <MotionPlanRequest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_msgs-msg:cartesian_speed_limited_link-val is deprecated.  Use moveit_msgs-msg:cartesian_speed_limited_link instead.")
  (cartesian_speed_limited_link m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MotionPlanRequest>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'max_acceleration_scaling_factor))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'cartesian_speed_limited_link))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'cartesian_speed_limited_link))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MotionPlanRequest>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
    ...
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'cartesian_speed_limited_link) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'cartesian_speed_limited_link) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MotionPlanRequest>)))
  ...
  "83f3d7b1d47a538f7659e0de9dae7980")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MotionPlanRequest)))
  "Returns md5sum for a message object of type 'MotionPlanRequest"
  "83f3d7b1d47a538f7659e0de9dae7980")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MotionPlanRequest>))
  (cl:+ 0
     ...
     8
     8
     4 (cl:length (cl:slot-value msg 'cartesian_speed_limited_link))
     8
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MotionPlanRequest>))
  ...
  (cl:list 'MotionPlanRequest
    ...
    (cl:cons ':cartesian_speed_limited_link (cartesian_speed_limited_link msg))
