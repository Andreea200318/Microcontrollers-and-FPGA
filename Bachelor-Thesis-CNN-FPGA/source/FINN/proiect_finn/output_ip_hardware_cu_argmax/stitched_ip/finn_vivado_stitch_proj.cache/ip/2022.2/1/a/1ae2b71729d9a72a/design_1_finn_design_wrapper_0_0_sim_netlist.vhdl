...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_StreamingFIFO_rtl_3_imp_92O214 is
  port (
    s_axis_tready : out STD_LOGIC;
    m_axis_tvalid : out STD_LOGIC;
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_StreamingFIFO_rtl_3_imp_92O214;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_StreamingFIFO_rtl_3_imp_92O214 is
  component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_finn_design_fifo_2 is
  port (
    s_axis_aresetn : in STD_LOGIC;
    s_axis_aclk : in STD_LOGIC;
    s_axis_tvalid : in STD_LOGIC;
  ...
  end component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_finn_design_fifo_2;
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of fifo : label is "axis_data_fifo_v2_0_9_top,Vivado 2022.2";
begin
fifo: component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_finn_design_fifo_2
     port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_finn_design is
  ...
  component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_finn_design_StreamingDataWidthConverter_rtl_2_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst_n : in STD_LOGIC;
    in0_V_TREADY : out STD_LOGIC;
  ...
  end component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_finn_design_StreamingDataWidthConverter_rtl_2_0;
  ...
  component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_finn_design_StreamingFIFO_rtl_9_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst_n : in STD_LOGIC;
    count : out STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  end component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_finn_design_StreamingFIFO_rtl_9_0;
...
StreamingDataWidthConverter_rtl_2: component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_finn_design_StreamingDataWidthConverter_rtl_2_0
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
...
StreamingFIFO_rtl_3: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_StreamingFIFO_rtl_3_imp_92O214
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      in0_V_tready => StreamingFIFO_rtl_3_out_V_TREADY,
...
StreamingFIFO_rtl_9: component decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_finn_design_StreamingFIFO_rtl_9_0
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
