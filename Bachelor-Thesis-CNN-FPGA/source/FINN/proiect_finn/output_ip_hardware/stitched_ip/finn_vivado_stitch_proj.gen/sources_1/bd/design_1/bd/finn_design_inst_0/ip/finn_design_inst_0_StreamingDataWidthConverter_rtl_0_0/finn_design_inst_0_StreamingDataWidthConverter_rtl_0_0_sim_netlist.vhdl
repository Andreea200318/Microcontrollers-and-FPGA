...
-- Command     : write_vhdl -force -mode funcsim -rename_top finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0 -prefix
--               finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0_
...
entity finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0_dwc is
  port (
...
end finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0_dwc;

architecture STRUCTURE of finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0_dwc is
  ...
  signal \genUp.ADat[15][7]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \genUp.ACnt[4]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \genUp.ACnt[4]_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \genUp.ACnt[4]_i_5\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \genUp.ACnt[4]_i_6\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \genUp.ADat[15][0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \genUp.ADat[15][1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \genUp.ADat[15][2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \genUp.ADat[15][3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \genUp.ADat[15][4]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \genUp.ADat[15][5]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \genUp.ADat[15][6]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \genUp.ADat[15][7]_i_2\ : label is "soft_lutpair7";
...
\genUp.ADat[15][2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
...
\genUp.ADat[15][3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
...
\genUp.ADat[15][4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
...
\genUp.ADat[15][5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
...
\genUp.ADat[15][6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
...
\genUp.ADat[15][7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"D0DD"
    )
        port map (
      ...
      I2 => in0_V_TVALID,
      I3 => \^s_axis_tready\,
      O => \genUp.ADat[15][7]_i_1_n_0\
    );
\genUp.ADat[15][7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0_dwc_axi is
  port (
...
end finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0_dwc_axi;

architecture STRUCTURE of finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0_dwc_axi is
begin
core: entity work.finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0_dwc
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0_StreamingDataWidthConverter_rtl_0 is
  port (
    out_V_TVALID : out STD_LOGIC;
    s_axis_tready : out STD_LOGIC;
    out_V_TDATA : out STD_LOGIC_VECTOR ( 127 downto 0 );
...
end finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0_StreamingDataWidthConverter_rtl_0;

architecture STRUCTURE of finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0_StreamingDataWidthConverter_rtl_0 is
begin
impl: entity work.finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0_dwc_axi
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      in0_V_TDATA(7 downto 0) => in0_V_TDATA(7 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst_n : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0 : entity is "finn_design_StreamingDataWidthConverter_rtl_0_0,StreamingDataWidthConverter_rtl_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0 : entity is "StreamingDataWidthConverter_rtl_0,Vivado 2022.2";
end finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0;

architecture STRUCTURE of finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0 is
...
begin
inst: entity work.finn_design_inst_0_StreamingDataWidthConverter_rtl_0_0_StreamingDataWidthConverter_rtl_0
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      in0_V_TDATA(7 downto 0) => in0_V_TDATA(7 downto 0),
