...
--               /home/andreea/proiect_finn/output_ip_hardware_cu_maimulteepoici/stitched_ip/finn_vivado_stitch_proj.gen/sources_1/bd/design_1/bd/finn_design_inst_0/ip/finn_design_inst_0_FMPadding_rtl_0_0/finn_design_inst_0_FMPadding_rtl_0_0_sim_netlist.vhdl
...
entity finn_design_inst_0_FMPadding_rtl_0_0_axi2we is
  port (
  ...
  attribute ORIG_REF_NAME of finn_design_inst_0_FMPadding_rtl_0_0_axi2we : entity is "axi2we";
end finn_design_inst_0_FMPadding_rtl_0_0_axi2we;

architecture STRUCTURE of finn_design_inst_0_FMPadding_rtl_0_0_axi2we is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_inst_0_FMPadding_rtl_0_0_fmpadding is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_inst_0_FMPadding_rtl_0_0_fmpadding : entity is "fmpadding";
end finn_design_inst_0_FMPadding_rtl_0_0_fmpadding;

architecture STRUCTURE of finn_design_inst_0_FMPadding_rtl_0_0_fmpadding is
  ...
  signal \A_reg[dat]\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal \B[dat][7]_i_3_n_0\ : STD_LOGIC;
...
\B[dat][7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2202"
    )
        port map (
...
\B[dat][7]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\B[dat][7]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"CA"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_inst_0_FMPadding_rtl_0_0_fmpadding_axi is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_inst_0_FMPadding_rtl_0_0_fmpadding_axi : entity is "fmpadding_axi";
end finn_design_inst_0_FMPadding_rtl_0_0_fmpadding_axi;

architecture STRUCTURE of finn_design_inst_0_FMPadding_rtl_0_0_fmpadding_axi is
...
begin
axilight_adapter: entity work.finn_design_inst_0_FMPadding_rtl_0_0_axi2we
     port map (
...
padding: entity work.finn_design_inst_0_FMPadding_rtl_0_0_fmpadding
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_inst_0_FMPadding_rtl_0_0_FMPadding_rtl_0 is
  port (
    E : out STD_LOGIC_VECTOR ( 0 to 0 );
    \B_reg[vld]\ : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_inst_0_FMPadding_rtl_0_0_FMPadding_rtl_0 : entity is "FMPadding_rtl_0";
end finn_design_inst_0_FMPadding_rtl_0_0_FMPadding_rtl_0;

architecture STRUCTURE of finn_design_inst_0_FMPadding_rtl_0_0_FMPadding_rtl_0 is
begin
impl: entity work.finn_design_inst_0_FMPadding_rtl_0_0_fmpadding_axi
     port map (
      \A_reg[vld]_inv\ => E(0),
      \B_reg[vld]\ => \B_reg[vld]\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_inst_0_FMPadding_rtl_0_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst_n : in STD_LOGIC;
    s_axilite_AWVALID : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of finn_design_inst_0_FMPadding_rtl_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of finn_design_inst_0_FMPadding_rtl_0_0 : entity is "finn_design_inst_0_FMPadding_rtl_0_0,FMPadding_rtl_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of finn_design_inst_0_FMPadding_rtl_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of finn_design_inst_0_FMPadding_rtl_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of finn_design_inst_0_FMPadding_rtl_0_0 : entity is "FMPadding_rtl_0,Vivado 2022.2";
end finn_design_inst_0_FMPadding_rtl_0_0;

architecture STRUCTURE of finn_design_inst_0_FMPadding_rtl_0_0 is
  signal \<const0>\ : STD_LOGIC;
  signal \<const1>\ : STD_LOGIC;
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of ap_clk : signal is "xilinx.com:signal:clock:1.0 ap_clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of ap_clk : signal is "XIL_INTERFACENAME ap_clk, ASSOCIATED_RESET ap_rst_n, ASSOCIATED_BUSIF in0_V:out_V:s_axilite, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
...
inst: entity work.finn_design_inst_0_FMPadding_rtl_0_0_FMPadding_rtl_0
     port map (
