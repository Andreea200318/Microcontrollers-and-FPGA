...
--               /home/andreea/proiect_finn/output_ip_hardware_cu_maimulteepoici/stitched_ip/finn_vivado_stitch_proj.gen/sources_1/bd/design_1/bd/finn_design_inst_0/ip/finn_design_inst_0_StreamingFIFO_rtl_6_0/finn_design_inst_0_StreamingFIFO_rtl_6_0_sim_netlist.vhdl
...
entity finn_design_inst_0_StreamingFIFO_rtl_6_0_Q_srl is
  port (
  ...
  attribute ORIG_REF_NAME of finn_design_inst_0_StreamingFIFO_rtl_6_0_Q_srl : entity is "Q_srl";
end finn_design_inst_0_StreamingFIFO_rtl_6_0_Q_srl;

architecture STRUCTURE of finn_design_inst_0_StreamingFIFO_rtl_6_0_Q_srl is
  ...
  attribute SOFT_HLUTNM of \addr[3]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \addr[3]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \addr[4]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \addr[4]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of addr_full_i_3 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of addr_full_i_4 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of addr_full_i_5 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of addr_full_i_6 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \count[0]_INST_0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \count[1]_INST_0\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \count[2]_INST_0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \count[3]_INST_0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \count[4]_INST_0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \count[5]_INST_0\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \maxcount_reg[5]_i_3\ : label is "soft_lutpair2";
...
addr_full_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F844"
    )
        port map (
...
addr_full_i_6: unisim.vcomponents.LUT5
    generic map(
      INIT => X"4B044F00"
    )
        port map (
...
\maxcount_reg[5]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\srlo[127]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FEEEF000"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_inst_0_StreamingFIFO_rtl_6_0_StreamingFIFO_rtl_6 is
  port (
    count : out STD_LOGIC_VECTOR ( 5 downto 0 );
    out_V_TDATA : out STD_LOGIC_VECTOR ( 127 downto 0 );
    out_V_TVALID : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_inst_0_StreamingFIFO_rtl_6_0_StreamingFIFO_rtl_6 : entity is "StreamingFIFO_rtl_6";
end finn_design_inst_0_StreamingFIFO_rtl_6_0_StreamingFIFO_rtl_6;

architecture STRUCTURE of finn_design_inst_0_StreamingFIFO_rtl_6_0_StreamingFIFO_rtl_6 is
begin
impl: entity work.finn_design_inst_0_StreamingFIFO_rtl_6_0_Q_srl
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      count(5 downto 0) => count(5 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_inst_0_StreamingFIFO_rtl_6_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst_n : in STD_LOGIC;
    count : out STD_LOGIC_VECTOR ( 5 downto 0 );
  ...
  attribute NotValidForBitStream of finn_design_inst_0_StreamingFIFO_rtl_6_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of finn_design_inst_0_StreamingFIFO_rtl_6_0 : entity is "finn_design_inst_0_StreamingFIFO_rtl_6_0,StreamingFIFO_rtl_6,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of finn_design_inst_0_StreamingFIFO_rtl_6_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of finn_design_inst_0_StreamingFIFO_rtl_6_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of finn_design_inst_0_StreamingFIFO_rtl_6_0 : entity is "StreamingFIFO_rtl_6,Vivado 2022.2";
end finn_design_inst_0_StreamingFIFO_rtl_6_0;

architecture STRUCTURE of finn_design_inst_0_StreamingFIFO_rtl_6_0 is
...
begin
inst: entity work.finn_design_inst_0_StreamingFIFO_rtl_6_0_StreamingFIFO_rtl_6
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      count(5 downto 0) => count(5 downto 0),
