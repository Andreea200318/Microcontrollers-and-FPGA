...
-- Date        : Sun Apr 19 14:08:31 2026
-- Host        : DESKTOP-N2392HC running 64-bit Ubuntu 24.04.4 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/andreea/proiect_finn/output_ip_hardware_cu_maimulteepoici/stitched_ip/finn_vivado_stitch_proj.gen/sources_1/bd/design_1/ip/design_1_axis_subset_converter_0_0/design_1_axis_subset_converter_0_0_sim_netlist.vhdl
...
entity design_1_axis_subset_converter_0_0_axis_subset_converter_v1_1_27_core is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_axis_subset_converter_0_0_axis_subset_converter_v1_1_27_core : entity is "axis_subset_converter_v1_1_27_core";
end design_1_axis_subset_converter_0_0_axis_subset_converter_v1_1_27_core;

architecture STRUCTURE of design_1_axis_subset_converter_0_0_axis_subset_converter_v1_1_27_core is
  ...
  signal \gen_pulsed_tlast_cntr.pulsed_tlast_cntr[1]_i_1_n_0\ : STD_LOGIC;
  signal \gen_pulsed_tlast_cntr.pulsed_tlast_cntr[2]_i_1_n_0\ : STD_LOGIC;
  signal \gen_pulsed_tlast_cntr.pulsed_tlast_cntr[3]_i_3_n_0\ : STD_LOGIC;
  signal \gen_pulsed_tlast_cntr.pulsed_tlast_cntr_reg\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \gen_pulsed_tlast_cntr.pulsed_tlast_cntr[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \gen_pulsed_tlast_cntr.pulsed_tlast_cntr[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \gen_pulsed_tlast_cntr.pulsed_tlast_cntr[3]_i_3\ : label is "soft_lutpair0";
...
\gen_pulsed_tlast_cntr.pulsed_tlast_cntr[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"33C4"
    )
        port map (
      ...
      O => \gen_pulsed_tlast_cntr.pulsed_tlast_cntr[1]_i_1_n_0\
    );
\gen_pulsed_tlast_cntr.pulsed_tlast_cntr[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      O => \gen_pulsed_tlast_cntr.pulsed_tlast_cntr[2]_i_1_n_0\
    );
\gen_pulsed_tlast_cntr.pulsed_tlast_cntr[3]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\gen_pulsed_tlast_cntr.pulsed_tlast_cntr[3]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\gen_pulsed_tlast_cntr.pulsed_tlast_cntr[3]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6AA2"
    )
        port map (
      ...
      I2 => \gen_pulsed_tlast_cntr.pulsed_tlast_cntr_reg\(2),
      I3 => \gen_pulsed_tlast_cntr.pulsed_tlast_cntr_reg\(1),
      O => \gen_pulsed_tlast_cntr.pulsed_tlast_cntr[3]_i_3_n_0\
    );
...
\gen_pulsed_tlast_cntr.pulsed_tlast_cntr_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => aclk,
      CE => \gen_pulsed_tlast_cntr.pulsed_tlast_cntr\,
      D => \gen_pulsed_tlast_cntr.pulsed_tlast_cntr[1]_i_1_n_0\,
...
\gen_pulsed_tlast_cntr.pulsed_tlast_cntr_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => aclk,
      CE => \gen_pulsed_tlast_cntr.pulsed_tlast_cntr\,
      D => \gen_pulsed_tlast_cntr.pulsed_tlast_cntr[2]_i_1_n_0\,
...
\gen_pulsed_tlast_cntr.pulsed_tlast_cntr_reg[3]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => aclk,
      CE => \gen_pulsed_tlast_cntr.pulsed_tlast_cntr\,
      D => \gen_pulsed_tlast_cntr.pulsed_tlast_cntr[3]_i_3_n_0\,
...
entity design_1_axis_subset_converter_0_0_top_design_1_axis_subset_converter_0_0 is
  ...
  attribute C_DEFAULT_TLAST of design_1_axis_subset_converter_0_0_top_design_1_axis_subset_converter_0_0 : entity is 10;
...
axis_subset_converter_v1_1_27_core: entity work.design_1_axis_subset_converter_0_0_axis_subset_converter_v1_1_27_core
     port map (
      aclk => aclk,
      aresetn => aresetn,
...
architecture STRUCTURE of design_1_axis_subset_converter_0_0 is
  ...
  attribute C_DEFAULT_TLAST : integer;
  attribute C_DEFAULT_TLAST of inst : label is 10;
  attribute C_FAMILY : string;
