...
HD_PWD='/home/andreea/proiect_finn/output_ip_hardware_cu_maimulteepoici/stitched_ip/finn_vivado_stitch_proj.runs/design_1_processing_system7_0_0_synth_1'
cd "$HD_PWD"
