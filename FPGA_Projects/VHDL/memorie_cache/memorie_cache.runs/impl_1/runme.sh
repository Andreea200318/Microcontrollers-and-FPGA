...
HD_PWD='D:/memorie_cache/memorie_cache.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log momorie_cache.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source momorie_cache.tcl -notrace
