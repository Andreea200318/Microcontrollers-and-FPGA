...
HD_PWD='D:/memorie_cache/memorie_cache.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log momorie_cache.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source momorie_cache.tcl
