...
#
# Script generated by Vivado on Sat Oct 12 17:51:06 +0300 2024
...
#
# Usage        : fp_abs.sh
#                fp_abs.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fp_abs.sh [-reset_run]
#                fp_abs.sh [-reset_log]
#                fp_abs.sh [-help]
#
...
#                script (type 'fp_abs.sh -help' for more information).
#
...
# script info
echo -e "fp_abs.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fp_abs.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fp_abs xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fp_abs -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fp_abs_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: fp_abs.sh [-step]\n\
Usage: fp_abs.sh [-lib_map_path]\n\
Usage: fp_abs.sh [-reset_run]\n\
Usage: fp_abs.sh [-reset_log]\n\
Usage: fp_abs.sh [-keep_index]\n\
