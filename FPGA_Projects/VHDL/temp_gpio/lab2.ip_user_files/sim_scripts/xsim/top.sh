...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="F:/Facultate/Vivado/2024.1/data/xsim"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xpm xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_dsp48_multadd_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 floating_point_v7_1_18 axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_13)
