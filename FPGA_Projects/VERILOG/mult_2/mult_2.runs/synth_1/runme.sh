...
HD_PWD='C:/Users/Andreea/Microcontrollers-and-FPGA/FPGA_Projects/VERILOG/mult_2/mult_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_n.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_n.tcl
