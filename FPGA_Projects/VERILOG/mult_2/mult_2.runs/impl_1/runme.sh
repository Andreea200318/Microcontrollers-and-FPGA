...
HD_PWD='C:/Users/Andreea/Microcontrollers-and-FPGA/FPGA_Projects/VERILOG/mult_2/mult_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_n.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mult_n.tcl -notrace
