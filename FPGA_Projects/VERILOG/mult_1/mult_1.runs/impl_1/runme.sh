...
HD_PWD='C:/Users/Andreea/Microcontrollers-and-FPGA/FPGA_Projects/VERILOG/mult_1/mult_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mult1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mult1.tcl -notrace
