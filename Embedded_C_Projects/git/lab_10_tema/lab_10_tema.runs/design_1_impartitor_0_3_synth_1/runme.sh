...
HD_PWD='D:/lab_10_tema/lab_10_tema.runs/design_1_impartitor_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_impartitor_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_impartitor_0_3.tcl
