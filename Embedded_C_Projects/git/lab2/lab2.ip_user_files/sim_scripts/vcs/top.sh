...
design_libs=(xpm xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_dsp48_multadd_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 floating_point_v7_1_18 xil_defaultlib axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_13)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../lab2.gen/sources_1/ip/fifo32x64/hdl" \
  ...
  vlogan -work floating_point_v7_1_18 $vlogan_opts +v2k +incdir+"../../../lab2.gen/sources_1/ip/fifo32x64/hdl" \
  "../../ipstatic/hdl/floating_point_v7_1_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../lab2.gen/sources_1/ip/fifo32x64/hdl" \
  "../../../lab2.gen/sources_1/ip/fp_subtractor/sim/fp_subtractor.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axis_infrastructure_v1_1_1 $vlogan_opts +v2k +incdir+"../../../lab2.gen/sources_1/ip/fifo32x64/hdl" \
  "../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axis_data_fifo_v2_0_13 $vlogan_opts +v2k +incdir+"../../../lab2.gen/sources_1/ip/fifo32x64/hdl" \
