...
#
# Script generated by Vivado on Mon Oct 07 18:50:45 +0300 2024
...
#
# Usage        : fifo32x64.sh
#                fifo32x64.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo32x64.sh [-reset_run]
#                fifo32x64.sh [-reset_log]
#                fifo32x64.sh [-help]
#
...
# script info
echo -e "fifo32x64.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo32x64.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo32x64 xil_defaultlib.fifo32x64 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo32x64.wdb xsim.dir libdpi.so)
...
Usage: fifo32x64.sh [-step]\n\
Usage: fifo32x64.sh [-lib_map_path]\n\
Usage: fifo32x64.sh [-reset_run]\n\
Usage: fifo32x64.sh [-reset_log]\n\
Usage: fifo32x64.sh [-keep_index]\n\
