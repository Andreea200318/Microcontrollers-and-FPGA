...
if("TRUE" STREQUAL "TRUE")
  set(panda_simulation_SOURCE_PREFIX /home/andreea/ws_moveit/src/panda_simulation)
  set(panda_simulation_DEVEL_PREFIX /home/andreea/ws_moveit/devel/.private/panda_simulation)
  ...
  set(panda_simulation_INSTALL_PREFIX /home/andreea/ws_moveit/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'panda_simulation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/andreea/ws_moveit/src/panda_simulation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/andreea/ws_moveit/devel/.private/panda_simulation/lib;/home/andreea/ws_moveit/devel/lib;/opt/ros/noetic/lib)
